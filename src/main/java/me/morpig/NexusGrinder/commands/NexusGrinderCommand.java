...
public class NexusGrinderCommand implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label,
		...
		if (args.length == 0) {
			sender.sendMessage(prefix + white + "NexusGrinder v" + plugin.getDescription().getVersion() + " by morpigthekidMC, RamsCrafter and _BritishCow_");
			...
			sender.sendMessage(prefix + gray + "/nexusgrinder " + dgray + "-" + white + " Show plugin information.");
			sender.sendMessage(prefix + gray + "/nexusgrinder start " + dgray + "-" + white + " Begin the game.");
		}
